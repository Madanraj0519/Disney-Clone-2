...
const Details = () => {
  ...
  return (
    <Container>
      <Background>
        <img alt={selectedMovie} src={`${IMAGE_BASE_URL}${selectedMovie.poster_path}`} />
      </Background>

      <ImageTitle>
        {/* <img alt={selectedMovie.original_title} src={`${IMAGE_BASE_URL}${selectedMovie.poster_path}`} /> */}
      </ImageTitle>
      <ContentMeta>
        <Controls>
          <Player>
        ...
        <SubTitle>{selectedMovie.original_title}</SubTitle>
